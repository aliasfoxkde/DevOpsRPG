...
const ALL_GAMES: GameEntry[] = [
  // DevOps & Programming
  {
    ...
    icon: '⚔️',
    category: 'DevOps',
    description: 'Master DevOps through quests',
    difficulty: 'Beginner',
    players: 'Solo',
  ...
  },
  {
    ...
    description: 'Learn Python/JavaScript through RPG battles',
    difficulty: 'Beginner',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '🌳',
    category: 'DevOps',
    description: 'Navigate version control challenges',
    difficulty: 'Beginner',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '🐳',
    category: 'DevOps',
    description: 'Containerize apps and race against time',
  ...
  },
  {
    ...
    icon: '👑',
    category: 'DevOps',
    description: 'Rule the Kubernetes realm',
    difficulty: 'Advanced',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '🔧',
    category: 'DevOps',
    description: 'Build CI/CD pipelines block by block',
    difficulty: 'Intermediate',
    players: 'Solo',
  ...
  // Math Games
  {
    ...
    icon: '🌀',
    category: 'Math',
    description: 'Race to solve arithmetic in stormy conditions',
    difficulty: 'Beginner',
    players: '1-4',
  ...
  },
  {
    ...
    icon: '📐',
    category: 'Math',
    description: 'Shape matching and spatial reasoning',
    difficulty: 'Beginner',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '⚡',
    category: 'Math',
    description: 'Solve equations to defeat enemies',
    difficulty: 'Intermediate',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '∞',
    category: 'Math',
    description: 'Derivatives and integrals under pressure',
    difficulty: 'Advanced',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '📊',
    category: 'Math',
    description: 'Probability and statistics adventures',
    difficulty: 'Intermediate',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '🧩',
    category: 'Math',
    description: 'Solve logic puzzles with grids',
    difficulty: 'Intermediate',
    players: 'Solo',
  ...
  // Science Games
  {
    ...
    icon: '⚛️',
    category: 'Science',
    description: 'Build molecules and explore chemistry',
    difficulty: 'Beginner',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '🎯',
    category: 'Science',
    description: 'Physics-based platformer challenges',
    difficulty: 'Intermediate',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '🧬',
    category: 'Science',
    description: 'Journey through cells and DNA',
    difficulty: 'Intermediate',
    players: 'Solo',
    color: 'from-green-600 to-emerald-500',
  },
  {
    ...
    icon: '🚀',
    category: 'Science',
    description: 'Navigate orbital mechanics',
    difficulty: 'Advanced',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '🌍',
    category: 'Science',
    description: 'Explore geology and ecosystems',
    difficulty: 'Beginner',
    players: 'Solo',
  ...
  // Reading & Language
  {
    ...
    icon: '✨',
    category: 'Reading',
    description: 'Spelling bees and vocabulary battles',
    difficulty: 'Beginner',
    players: '1-4',
  ...
  },
  {
    ...
    icon: '📖',
    category: 'Reading',
    description: 'Create stories with writing prompts',
    difficulty: 'Beginner',
    players: 'Solo',
  ...
  {
    id: 'grammargrapple',
    name: 'Grammar Grapple',
    icon: '🥊',
    category: 'Reading',
    description: 'Fight grammar errors in the arena',
    difficulty: 'Intermediate',
    players: 'Solo',
    color: 'from-blue-600 to-cyan-500',
  },
  {
    ...
    icon: '⚡',
    category: 'Reading',
    description: 'Read fast, answer faster',
    difficulty: 'Intermediate',
    players: 'Solo',
  ...
  // Robotics & Engineering
  {
    ...
    icon: '🤖',
    category: 'Robotics',
    description: 'Program robots to complete courses',
    difficulty: 'Intermediate',
    players: '1-4',
  ...
  },
  {
    ...
    description: 'Build bridges and test physics',
    difficulty: 'Intermediate',
    players: 'Solo',
  ...
  // Trivia & Knowledge
  {
    ...
    icon: '🏅',
    category: 'Trivia',
    description: 'Compete in knowledge showdowns',
    difficulty: 'Mixed',
    players: '1-8',
  ...
  },
  {
    ...
    icon: '🔬',
    category: 'Trivia',
    description: 'Discover science facts and phenomena',
    difficulty: 'Mixed',
    players: '1-4',
  ...
  },
  {
    ...
    icon: '🌐',
    category: 'Trivia',
    description: 'Explore countries, capitals, and cultures',
    difficulty: 'Mixed',
    players: 'Solo',
    color: 'from-green-600 to-emerald-500',
  },
  ...
  // Puzzle Games
  {
    ...
    icon: '🌀',
    category: 'Puzzle',
    description: 'Navigate increasingly complex labyrinths',
    difficulty: 'Beginner',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '🔮',
    category: 'Puzzle',
    description: 'Find sequences and predict next elements',
    difficulty: 'Intermediate',
    players: 'Solo',
  ...
  },
  {
    ...
    icon: '⛰️',
    category: 'Puzzle',
    description: 'Solve riddles to climb the mountain',
    difficulty: 'Advanced',
    players: 'Solo',
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredGames.map((game) => (
            ...
            >
              {/* Header */}
              <div
                className={`h-24 bg-gradient-to-br ${game.color} flex items-center justify-center relative`}
              >
