              ...
              {isCompleted ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="px-6 sm:px-8 py-3 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white font-bold rounded-lg shadow-lg transform transition-all hover:scale-105 text-sm sm:text-base"
                  >
                    ⚔️ Complete (+{quest.xpReward} XP)
                  </button>
                </>
              )}
            </div>
