...
// Provides properly styled SVG icons for core actions
...
const ICONS: Record<IconName, ReactElement> = {
  ...
  trophy: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M5 3v4M3 5h4a2 2 0 012 2v4m0-4v4m0 0h8m-8 0h12m0-8v4m0 0v4M7 21h4m0 0h2a2 2 0 002-2v-4a2 2 0 00-2-2H7a2 2 0 00-2 2v4a2 2 0 002 2zm10 0h2a2 2 0 002-2v-4a2 2 0 00-2-2h-2a2 2 0 00-2 2v4a2 2 0 002 2z"
    />
  ),
  medal: (
    <path
  ...
  crown: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M5 3l3.057-2 3.943 2 3.943-2 3.057 2M5 3v6.5L12 14l7-4.5V3M3 17l2 4 4-2 4 2 2-4"
    />
  ),
  fire: (
    <path
  ...
  unlink: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m4.899-.758a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1M2 2l20 20"
    />
  ),
  globe: (
    <path
