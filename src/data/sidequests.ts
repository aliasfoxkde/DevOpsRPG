...
type SideQuestType = 'daily' | 'weekly' | 'secret'
...
export const DAILY_QUESTS_POOL: Omit<SideQuest, 'completed' | 'progress'>[] = [
  ...
  },
  {
    ...
    icon: '⚔️',
    requirement: { type: 'complete_quests', count: 3 },
    rewards: { xp: 125, gold: 50 },
  },
  {
    id: 'daily_xp_1',
    type: 'daily',
    ...
    icon: '✨',
    requirement: { type: 'earn_xp', count: 200 },
  ...
  },
  {
    ...
    icon: '💫',
    requirement: { type: 'earn_xp', count: 500 },
  ...
  },
  {
    ...
    icon: '🔥',
    requirement: { type: 'maintain_streak', count: 1 },
  ...
  },
  {
    ...
    type: 'daily',
    title: 'Game Player',
    description: 'Complete 1 mini-game',
    icon: '🎮',
    requirement: { type: 'minigame', count: 1 },
  ...
  },
  {
    ...
    type: 'daily',
    title: 'Quiz Master',
    description: 'Pass 2 quizzes',
    icon: '🧠',
    requirement: { type: 'quiz', count: 2 },
...
export const WEEKLY_QUESTS_POOL: Omit<SideQuest, 'completed' | 'progress'>[] = [
  {
    ...
    icon: '📜',
    requirement: { type: 'complete_quests', count: 15 },
    rewards: { xp: 500, gold: 200, badge: 'weekly_warrior' },
  },
  {
    id: 'weekly_xp',
    type: 'weekly',
    ...
    icon: '🏆',
    requirement: { type: 'earn_xp', count: 2000 },
    rewards: { xp: 300, gold: 150, badge: 'xp_champion' },
  },
  {
    id: 'weekly_streak',
    type: 'weekly',
    ...
    rewards: { xp: 400, gold: 200, badge: 'streak_master' },
  },
  {
    id: 'weekly_minigames',
    type: 'weekly',
    title: 'Gamer Elite',
    description: 'Complete 5 mini-games this week',
    icon: '🎮',
    requirement: { type: 'minigame', count: 5 },
  ...
  },
  {
    ...
    rewards: { xp: 350, gold: 175, badge: 'quiz_legend' },
  },
]
...
export const SECRET_QUESTS_POOL: Omit<SideQuest, 'completed' | 'progress' | 'expiresAt'>[] = [
  {
    ...
    icon: '🐦',
    requirement: { type: 'complete_quests', count: 1 },
    rewards: { xp: 100, gold: 50, badge: 'early_bird' },
  },
  {
    id: 'secret_night_owl',
    type: 'secret',
    ...
    icon: '🦉',
    requirement: { type: 'complete_quests', count: 1 },
    rewards: { xp: 100, gold: 50, badge: 'night_owl' },
  },
  {
    ...
    icon: '⚡',
    requirement: { type: 'complete_quests', count: 1 },
    rewards: { xp: 150, gold: 75, badge: 'speed_demon' },
  },
  {
    ...
    icon: '💎',
    requirement: { type: 'quiz', count: 3 },
    rewards: { xp: 300, gold: 150, badge: 'perfectionist' },
  },
  {
    id: 'secret_explorer',
    type: 'secret',
    ...
    rewards: { xp: 200, gold: 100, badge: 'world_traveler' },
  },
  {
    id: 'secret_technology_collector',
    type: 'secret',
    title: 'Technology Collector',
    description: 'Complete at least 1 quest in each technology',
    icon: '🏅',
    requirement: { type: 'complete_quests', count: 10 },
    rewards: { xp: 250, gold: 125, badge: 'collector' },
  },
]
