...
export const BADGES: Badge[] = [
  ...
  },
  {
    ...
    description: 'Complete all 163 quests',
    icon: '👑',
    category: 'quest',
    rarity: 'legendary',
    requirement: { type: 'quest_count', value: 163 },
    xpReward: 5000,
    goldReward: 2500,
  },
  ...
  // Technology mastery badges
  {
    id: 'html_master',
    name: 'HTML Guru',
    description: 'Complete all HTML quests',
    icon: '📄',
    category: 'skill',
    rarity: 'uncommon',
    requirement: { type: 'tech_complete', value: 1, tech: 'html' },
    xpReward: 200,
    goldReward: 100,
  },
  {
    id: 'css_master',
    name: 'CSS Guru',
    description: 'Complete all CSS quests',
    icon: '🎨',
    category: 'skill',
    rarity: 'uncommon',
    requirement: { type: 'tech_complete', value: 1, tech: 'css' },
    xpReward: 200,
    goldReward: 100,
  },
  {
    ...
    category: 'skill',
    rarity: 'rare',
    requirement: { type: 'tech_complete', value: 1, tech: 'javascript' },
    xpReward: 300,
    goldReward: 150,
  },
  {
    id: 'python_master',
    name: 'Python Guru',
    description: 'Complete all Python quests',
    icon: '🐍',
    category: 'skill',
    rarity: 'rare',
    requirement: { type: 'tech_complete', value: 1, tech: 'python' },
    xpReward: 350,
    goldReward: 175,
  },
  {
    id: 'docker_master',
    name: 'Docker Guru',
    description: 'Complete all Docker quests',
    icon: '🐳',
    category: 'skill',
    rarity: 'rare',
    requirement: { type: 'tech_complete', value: 1, tech: 'docker' },
    xpReward: 400,
    goldReward: 200,
  },
  {
    id: 'kubernetes_master',
    name: 'Kubernetes Guru',
    description: 'Complete all Kubernetes quests',
    icon: '☸️',
    category: 'skill',
    rarity: 'epic',
    requirement: { type: 'tech_complete', value: 1, tech: 'kubernetes' },
    xpReward: 500,
    goldReward: 250,
  },
  {
    id: 'aws_master',
    name: 'AWS Guru',
    description: 'Complete all AWS quests',
    icon: '☁️',
    category: 'skill',
    rarity: 'epic',
    requirement: { type: 'tech_complete', value: 1, tech: 'aws' },
    xpReward: 500,
    goldReward: 250,
  },
  {
    id: 'devops_master',
    name: 'DevOps Sage',
    description: 'Complete the DevOps realm',
    icon: '🏆',
    category: 'skill',
    rarity: 'legendary',
    requirement: { type: 'tech_complete', value: 1, tech: 'cicd' },
    xpReward: 1000,
    goldReward: 500,
  },
  ...
  // Realm completion badges
  {
    ...
    description: 'Complete the Village of Foundations',
    icon: '🏘️',
    category: 'quest',
    rarity: 'uncommon',
    requirement: { type: 'realm_complete', value: 1 },
    xpReward: 200,
    goldReward: 100,
  },
  {
    ...
    description: 'Complete the Forest of Scripts',
    icon: '🌲',
    category: 'quest',
    rarity: 'rare',
    requirement: { type: 'realm_complete', value: 2 },
    xpReward: 300,
    goldReward: 150,
  },
  {
    id: 'frameworks_complete',
    name: 'Castle Champion',
    description: 'Complete the Castle of Frameworks',
    icon: '🏰',
    category: 'quest',
    rarity: 'rare',
    requirement: { type: 'realm_complete', value: 3 },
    xpReward: 400,
    goldReward: 200,
  },
  {
    ...
    description: 'Complete the Mountains of Cloud',
    icon: '⛰️',
    category: 'quest',
    rarity: 'epic',
    requirement: { type: 'realm_complete', value: 4 },
    xpReward: 600,
    goldReward: 300,
  },
  {
    id: 'devops_complete',
    name: 'True DevOps Master',
    description: 'Complete the Citadel of DevOps',
    icon: '🏛️',
    category: 'quest',
    rarity: 'legendary',
    requirement: { type: 'realm_complete', value: 5 },
    xpReward: 2000,
    goldReward: 1000,
  },
  ...
  // Minigame badges
  {
    ...
    category: 'quest',
    rarity: 'common',
    requirement: { type: 'minigame_count', value: 1 },
    xpReward: 30,
    goldReward: 15,
  },
  {
    ...
    category: 'quest',
    rarity: 'uncommon',
    requirement: { type: 'minigame_count', value: 10 },
    xpReward: 150,
    goldReward: 75,
  },
  {
    id: 'typer_10',
    name: 'Command Typer',
    description: 'Complete 10 Command Typer challenges',
    icon: '⌨️',
    category: 'skill',
    rarity: 'uncommon',
    requirement: { type: 'typer_count', value: 10 },
    xpReward: 100,
    goldReward: 50,
  },
  {
    ...
    category: 'skill',
    rarity: 'uncommon',
    requirement: { type: 'memory_count', value: 5 },
    xpReward: 100,
    goldReward: 50,
  },
  {
    ...
    category: 'skill',
    rarity: 'uncommon',
    requirement: { type: 'math_count', value: 5 },
    xpReward: 100,
    goldReward: 50,
  },
  ...
  // Secret badges
  {
    ...
    category: 'secret',
    rarity: 'rare',
    requirement: { type: 'early_quest', value: 1 },
    xpReward: 100,
    goldReward: 50,
  },
  {
    ...
    category: 'secret',
    rarity: 'rare',
    requirement: { type: 'night_quest', value: 1 },
    xpReward: 100,
    goldReward: 50,
  },
  {
    ...
    category: 'secret',
    rarity: 'epic',
    requirement: { type: 'speed_quest', value: 1 },
    xpReward: 200,
    goldReward: 100,
  },
  {
    id: 'collector',
    name: 'Collector',
    description: 'Earn a badge from each category',
    icon: '🏅',
    category: 'secret',
    rarity: 'epic',
  ...
  // More secret/hidden badges
  {
    id: 'lucky_spin',
    name: 'Lucky!',
    description: 'Win the jackpot (500+ gold) on the bonus wheel',
    icon: '🎰',
    category: 'secret',
    rarity: 'rare',
    requirement: { type: 'jackpot_spin', value: 1 },
    xpReward: 150,
    goldReward: 75,
  },
  {
    ...
    category: 'secret',
    rarity: 'common',
    requirement: { type: 'mystery_open', value: 1 },
    xpReward: 50,
    goldReward: 25,
  },
  {
  ...
  },
  {
    id: 'all_realms',
    name: 'World Explorer',
    description: 'Complete all 5 realms',
    icon: '🗺️',
    category: 'secret',
    rarity: 'legendary',
    requirement: { type: 'all_realms', value: 5 },
    xpReward: 2500,
    goldReward: 1250,
  },
  {
    id: 'all_tech',
    name: 'Tech Master',
    description: 'Complete quests in all technologies',
    icon: '🛠️',
    category: 'secret',
    rarity: 'epic',
    requirement: { type: 'all_technologies', value: 1 },
    xpReward: 750,
    goldReward: 375,
  },
  {
    ...
    category: 'secret',
    rarity: 'rare',
    requirement: { type: 'quiz_master', value: 50 },
    xpReward: 400,
    goldReward: 200,
  },
  {
    id: 'no_mistakes',
    name: 'Flawless',
    description: 'Complete 10 quests without any wrong answers',
    icon: '💎',
    category: 'secret',
    rarity: 'epic',
    requirement: { type: 'no_mistakes', value: 10 },
    xpReward: 500,
    goldReward: 250,
  },
  {
    ...
    category: 'secret',
    rarity: 'epic',
    requirement: { type: 'quiz_streak', value: 3 },
    xpReward: 300,
    goldReward: 150,
  },
  {
    ...
    category: 'secret',
    rarity: 'rare',
    requirement: { type: 'marathon', value: 10 },
    xpReward: 300,
    goldReward: 150,
  },
  {
    id: 'level_25',
    name: 'Max Level',
    description: 'Reach level 25 (max level)',
    icon: '⬆️',
    category: 'secret',
    rarity: 'legendary',
    requirement: { type: 'max_level', value: 25 },
    xpReward: 5000,
    goldReward: 2500,
  },
  {
    ...
    category: 'secret',
    rarity: 'epic',
    requirement: { type: 'gold_hoard', value: 10000 },
    xpReward: 500,
    goldReward: 0,
  },
  {
    id: 'first_legendary',
    name: 'Legendary',
    description: 'Earn your first legendary item',
    icon: '⭐',
    category: 'secret',
    rarity: 'uncommon',
    requirement: { type: 'first_legendary', value: 1 },
    xpReward: 200,
    goldReward: 100,
  },
  ...
  },
  {
    ...
    description: 'Maintain a 7-day streak through the week',
    icon: '🔥',
    category: 'streak',
    rarity: 'uncommon',
    requirement: { type: 'challenge_complete', value: 1 },
  ...
  },
  {
    id: 'quiz_wizard',
    name: 'Quiz Wizard',
    description: 'Pass 15 quizzes in a week',
    icon: '🧙',
    category: 'quest',
    rarity: 'uncommon',
    requirement: { type: 'challenge_complete', value: 1 },
  ...
  },
  {
    id: 'monthly_master',
    name: 'Monthly Master',
    description: 'Maintain a 30-day streak through the month',
    icon: '🔥',
    category: 'streak',
    rarity: 'epic',
    requirement: { type: 'challenge_complete', value: 1 },
  ...
  },
  {
    id: 'quiz_oracle',
    name: 'Quiz Oracle',
    description: 'Pass 75 quizzes in a month',
    icon: '🔮',
    category: 'quest',
    rarity: 'epic',
    requirement: { type: 'challenge_complete', value: 1 },
  ...
  // Side quest badges
  {
    id: 'weekly_warrior',
    name: 'Weekly Warrior',
    description: 'Complete the weekly warrior quest',
    icon: '💪',
    category: 'quest',
    rarity: 'uncommon',
    requirement: { type: 'sidequest_complete', value: 1 },
    xpReward: 200,
    goldReward: 100,
  },
  {
    id: 'xp_champion',
    name: 'XP Champion',
    description: 'Earn the XP champion title',
    icon: '💎',
    category: 'quest',
    rarity: 'uncommon',
    requirement: { type: 'sidequest_complete', value: 1 },
  ...
  },
  {
    id: 'streak_master',
    name: 'Streak Master',
    description: 'Achieve streak mastery',
    icon: '🔥',
    category: 'streak',
    rarity: 'rare',
    requirement: { type: 'sidequest_complete', value: 1 },
  ...
  },
  {
    id: 'quiz_legend',
    name: 'Quiz Legend',
    description: 'Become a quiz legend',
    icon: '🏅',
    category: 'quest',
    rarity: 'rare',
    requirement: { type: 'sidequest_complete', value: 1 },
  ...
  },
  {
    id: 'world_traveler',
    name: 'World Traveler',
    description: 'Explore all realms of DevOps',
    icon: '🌍',
    category: 'quest',
    rarity: 'epic',
    requirement: { type: 'sidequest_complete', value: 1 },
  ...
  // Milestone reward tier badges
  {
    ...
    category: 'quest',
    rarity: 'uncommon',
    requirement: { type: 'milestone_tier', value: 1 },
    xpReward: 150,
    goldReward: 75,
  },
  {
    ...
    category: 'quest',
    rarity: 'rare',
    requirement: { type: 'milestone_tier', value: 2 },
    xpReward: 300,
    goldReward: 150,
  },
  {
    ...
    category: 'quest',
    rarity: 'epic',
    requirement: { type: 'milestone_tier', value: 3 },
    xpReward: 600,
    goldReward: 300,
  },
  {
    ...
    category: 'quest',
    rarity: 'legendary',
    requirement: { type: 'milestone_tier', value: 4 },
    xpReward: 1200,
    goldReward: 600,
  },
  ...
  // Companion evolution badges
  {
    id: 'first_companion',
    name: 'Best Friends',
    description: 'Unlock your first companion',
    icon: '🐾',
    category: 'secret',
    rarity: 'uncommon',
    requirement: { type: 'companion_owned', value: 1 },
    xpReward: 100,
    goldReward: 50,
  },
  {
    ...
    description: 'Unlock all 4 companions',
    icon: '🎒',
    category: 'secret',
    rarity: 'epic',
    requirement: { type: 'companion_owned', value: 4 },
    xpReward: 500,
    goldReward: 250,
  },
  {
    ...
    description: 'Evolve your Owl to Elder Owl',
    icon: '🦉',
    category: 'secret',
    rarity: 'rare',
    requirement: { type: 'companion_evolution', value: 1 },
    xpReward: 300,
    goldReward: 150,
  },
  {
    id: 'cat_evolution',
    name: 'Shadow Stalker',
    description: 'Evolve your Cat to Shadow Cat',
    icon: '🐱',
    category: 'secret',
    rarity: 'rare',
    requirement: { type: 'companion_evolution', value: 1 },
  ...
  },
  {
    id: 'dragon_evolution',
    name: 'Ancient Fire',
    description: 'Evolve your Dragon to Elder Dragon',
    icon: '🐲',
    category: 'secret',
    rarity: 'epic',
    requirement: { type: 'companion_evolution', value: 1 },
  ...
  {
    id: 'phoenix_evolution',
    name: 'Eternal Flame',
    description: 'Evolve your Phoenix to Legendary Phoenix',
    icon: '🔥',
    category: 'secret',
    rarity: 'legendary',
    requirement: { type: 'companion_evolution', value: 1 },
  ...
  },
  {
    id: 'bond_master',
    name: 'Bond Master',
    description: 'Max bond level with any companion',
    icon: '💝',
    category: 'secret',
    rarity: 'epic',
    requirement: { type: 'max_bond_level', value: 10 },
    xpReward: 750,
    goldReward: 375,
  },
  ...
  },
  {
    ...
    category: 'secret',
    rarity: 'legendary',
    requirement: { type: 'prestige_level', value: 5 },
    xpReward: 2500,
    goldReward: 1250,
  },
  {
    ...
    description: 'Prestige 10 times - true mastery',
    icon: '👑',
    category: 'secret',
    rarity: 'legendary',
    requirement: { type: 'prestige_level', value: 10 },
    xpReward: 5000,
    goldReward: 2500,
  },
]
...
export const HANDLED_REQUIREMENT_TYPES = [
  'all_badges',
  'all_categories',
  'all_realms',
  'all_technologies',
...
export function shouldUnlockBadge(
  ...
  switch (badge.requirement.type) {
    ...
    case 'speed_quest':
      return (
        stats.fastestQuestTime != null &&
        stats.fastestQuestTime > 0 &&
        stats.fastestQuestTime <= badge.requirement.value * 60
      )
    case 'all_categories': {
