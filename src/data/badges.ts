...
export const BADGES: Badge[] = [
  ...
  { id: 'perfectionist', name: 'Perfectionist', description: 'Get 100% on 3 quizzes in a row', icon: '💎', category: 'secret', rarity: 'epic', requirement: { type: 'quiz_streak', value: 3 }, xpReward: 300, goldReward: 150 },
