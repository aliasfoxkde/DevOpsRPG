...
export const technologies: Record<string, Omit<Technology, 'category'>> = {
  ...
  css: {
    ...
    topics: [
      ...
      },
      {
        ...
        url: 'https://www.w3schools.com/css/css_dimensions.asp',
        order: 9,
      },
      {
        id: 'css_flexbox',
  ...
  git: {
    ...
    topics: [
      ...
      {
        id: 'git_getstarted',
        name: 'Git Get Started',
        slug: 'git-getstarted',
        url: 'https://www.w3schools.com/git/git_getstarted.asp',
        order: 2,
      },
      {
        id: 'git_branch',
      ...
      },
      {
        ...
        name: 'Git Remote',
        slug: 'git-remote',
        url: 'https://www.w3schools.com/git/git_remote.asp',
        order: 4,
      },
    ],
  },
  ...
  bash: {
    ...
    topics: [
      ...
      {
        id: 'bash_getstarted',
        name: 'Bash Get Started',
        slug: 'bash-getstarted',
        url: 'https://www.shellscript.sh/quickstart.html',
        order: 2,
      },
      {
        id: 'bash_script',
        name: 'Bash Scripting',
        slug: 'bash-script',
        url: 'https://www.shellscript.sh/examples.html',
        order: 3,
      },
      {
        id: 'bash_variables',
    ...
    topics: [
      {
        ...
        slug: 'docker-intro',
        url: 'https://www.w3schools.com/docker/docker_intro.asp',
        order: 1,
      },
      {
        id: 'docker_getstarted',
        name: 'Docker Get Started',
        slug: 'docker-getstarted',
        url: 'https://www.w3schools.com/docker/docker_getstarted.asp',
        order: 2,
      },
      {
        id: 'docker_images',
        name: 'Docker Images',
        slug: 'docker-images',
        url: 'https://www.w3schools.com/docker/docker_images.asp',
        order: 3,
      },
      {
        ...
        url: 'https://www.w3schools.com/docker/docker_containers.asp',
        order: 4,
      },
      {
        ...
        url: 'https://www.w3schools.com/docker/docker_dockerfile.asp',
        order: 5,
      },
    ],
  },
  ...
  nodejs: {
    ...
    topics: [
      ...
      {
        id: 'nodejs_getstarted',
        name: 'Node.js Get Started',
        slug: 'nodejs-getstarted',
        url: 'https://www.w3schools.com/nodejs/nodejs_getstarted.asp',
        order: 2,
      },
      {
        id: 'nodejs_modules',
    ...
    topics: [
      {
        ...
        url: 'https://www.w3schools.com/postgresql/postgresql_intro.asp',
        order: 1,
      },
      {
        id: 'postgresql_getstarted',
        name: 'PostgreSQL Get Started',
        slug: 'postgresql-getstarted',
        url: 'https://www.w3schools.com/postgresql/postgresql_getstarted.asp',
        order: 2,
      },
      {
        ...
        url: 'https://www.w3schools.com/postgresql/postgresql_create_table.asp',
        order: 3,
      },
      {
        id: 'postgresql_insert',
        name: 'PostgreSQL INSERT INTO',
        slug: 'postgresql-insert',
        url: 'https://www.w3schools.com/postgresql/postgresql_insert.asp',
        order: 4,
      },
      {
        ...
        url: 'https://www.w3schools.com/postgresql/postgresql_select.asp',
        order: 5,
      },
    ],
  },
    ...
    topics: [
      {
        ...
        slug: 'mongodb-intro',
        url: 'https://www.w3schools.com/mongodb/mongodb_intro.asp',
        order: 1,
      },
      {
        id: 'mongodb_getstarted',
        name: 'MongoDB Get Started',
        slug: 'mongodb-getstarted',
        url: 'https://www.w3schools.com/mongodb/mongodb_getstarted.asp',
        order: 2,
      },
      {
        id: 'mongodb_create_database',
        name: 'MongoDB Create Database',
        slug: 'mongodb-create-database',
        url: 'https://www.w3schools.com/mongodb/mongodb_create_database.asp',
        order: 3,
      },
      {
        id: 'mongodb_create_collection',
        name: 'MongoDB Create Collection',
        slug: 'mongodb-create-collection',
        url: 'https://www.w3schools.com/mongodb/mongodb_create_collection.asp',
        order: 4,
      },
      {
        id: 'mongodb_insert',
        name: 'MongoDB Insert',
        slug: 'mongodb-insert',
        url: 'https://www.w3schools.com/mongodb/mongodb_insert.asp',
        order: 5,
      },
    ],
  },
    ...
    topics: [
      {
        ...
        slug: 'aws-intro',
        url: 'https://www.w3schools.com/aws/aws_intro.asp',
        order: 1,
      },
      {
        id: 'aws_getstarted',
        ...
        slug: 'aws-getstarted',
        url: 'https://www.w3schools.com/aws/aws_getstarted.asp',
        order: 2,
      },
      {
        id: 'aws-ec2',
        name: 'AWS EC2',
        slug: 'aws-ec2',
        url: 'https://www.w3schools.com/aws/aws_ec2.asp',
        order: 3,
      },
      {
        id: 'aws-s3',
        name: 'AWS S3',
        slug: 'aws-s3',
        url: 'https://www.w3schools.com/aws/aws_s3.asp',
        order: 4,
      },
      {
        id: 'aws_rds',
        name: 'AWS RDS',
        slug: 'aws-rds',
        url: 'https://www.w3schools.com/aws/aws_rds.asp',
        order: 5,
      },
    ],
  },
  ...
  terraform: {
    ...
    topics: [
      ...
      },
      {
        ...
        slug: 'tf-getstarted',
        url: 'https://developer.hashicorp.com/terraform/tutorials/get-started',
        order: 2,
      },
      {
        id: 'tf_resources',
  ...
  prometheus: {
    ...
    topics: [
      ...
      {
        id: 'prom_getstarted',
        name: 'Prometheus Get Started',
        slug: 'prom-getstarted',
    ...
    topics: [
      {
        ...
        slug: 'sec-intro',
        url: 'https://www.redhat.com/en/topics/security',
        order: 1,
      },
      {
      ...
      },
      {
        ...
        slug: 'sec-secrets',
        url: 'https://www.vaultproject.io/docs/concepts/secrets',
        order: 3,
      },
      {
        id: 'sec_scanning',
    ...
    topics: [
      {
        ...
        slug: 'net-intro',
        url: 'https://www.cloudflare.com/learning/network-layer/what-is-networking/',
        order: 1,
      },
      {
        id: 'net_tcpip',
      ...
      },
      {
        ...
        name: 'Firewalls',
        slug: 'net-firewall',
        url: 'https://www.cloudflare.com/learning/ddos/glossary/network-layer-firewall/',
        order: 6,
      },
    ],
  },
  ...
  observability: {
    ...
    topics: [
      {
        id: 'obs_intro',
        name: 'Observability Introduction',
        slug: 'obs-intro',
      ...
      },
      {
        ...
        slug: 'obs-grafana',
        url: 'https://grafana.com/docs/grafana.com/dashboards/',
        order: 2,
      },
      {
        id: 'obs_loki',
      ...
      },
      {
        ...
        slug: 'obs-tracing',
        url: 'https://www.jaegertracing.io/docs/1.48/getting-started/',
        order: 4,
      },
      {
        id: 'obs_alerting',
  ...
  kafka: {
    ...
    topics: [
      ...
      },
      {
        ...
        name: 'Kafka Topics',
        slug: 'kafka-topics',
        url: 'https://kafka.apache.org/documentation/#topics',
        order: 2,
      },
      {
        id: 'kafka_producers',
        ...
        url: 'https://kafka.apache.org/documentation/#producers',
        order: 3,
      },
      {
        id: 'kafka_consumers',
        ...
        url: 'https://kafka.apache.org/documentation/#consumers',
        order: 4,
      },
      {
        id: 'kafka_streams',
  ...
  rabbitmq: {
    ...
    topics: [
      ...
      },
      {
        ...
        slug: 'rmq-exchanges',
        url: 'https://www.rabbitmq.com/tutorials/#tutorials-for-other-utilities',
        order: 2,
      },
      {
        id: 'rmq_queues',
  ...
  istio: {
    ...
    topics: [
      ...
      },
      {
        ...
        name: 'Istio Security',
        slug: 'istio-security',
        url: 'https://istio.io/latest/docs/tasks/security/',
        order: 3,
      },
      {
        id: 'istio_observability',
        name: 'Service Mesh Observability',
        slug: 'istio-observability',
