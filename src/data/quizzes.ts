  ...
  const quizzes: Record<string, QuizQuestion[]> = {
    ...
    html_forms: [
      {
        ...
        correctIndex: 1,
        explanation:
          'HTML forms are used to collect user input like text, selections, and buttons.',
      },
      {
        id: 'html_form_q2',
        topicId: 'html_forms',
    ...
    css_box_model: [
      {
        ...
        correctIndex: 1,
        explanation:
          'The CSS box model includes: content, padding, border, and margin (outside in).',
      },
      {
        id: 'css_box_q2',
        topicId: 'css_box_model',
    ...
    js_intro: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          'document.getElementById(id).innerHTML = "new content" changes element content.',
      },
    ],
    js_variables: [
      {
    ...
    sql_delete: [
      {
        ...
        correctIndex: 1,
        explanation:
          'DELETE removes rows from a table. Use with WHERE to avoid deleting everything.',
      },
      {
        id: 'sql_delete_q2',
        topicId: 'sql_delete',
    ...
    py_syntax: [
      {
        ...
        correctIndex: 1,
        explanation:
          'Python uses indentation to define code blocks, making it readability-focused.',
      },
      {
        id: 'py_syntax_q2',
        topicId: 'py_syntax',
        ...
        correctIndex: 2,
        explanation:
          'Python uses dynamic typing: x = 5 creates a variable without type declaration.',
      },
    ],
    py_variables: [
      {
    ...
    docker_containers: [
      {
        ...
        correctIndex: 1,
        explanation:
          'docker run creates and starts a new container. docker create just creates it.',
      },
      {
        id: 'docker_cont_q2',
        topicId: 'docker_containers',
    ...
    aws_intro: [
      {
        ...
        correctIndex: 1,
        explanation:
          'AWS stands for Amazon Web Services - a comprehensive cloud computing platform.',
      },
      {
        id: 'aws_intro_q2',
        topicId: 'aws_intro',
    ...
    tf_resources: [
      ...
      },
      {
        ...
        correctIndex: 2,
        explanation:
          '"aws_instance" is the Terraform resource type for creating AWS EC2 instances.',
      },
    ],
    ...
    prom_intro: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          'Prometheus collects and stores metrics as time series data (with timestamps).',
      },
    ],
    prom_metrics: [
      {
    ...
    net_http: [
      ...
      },
      {
        ...
        correctIndex: 2,
        explanation:
          '404 is the standard status code for "Not Found" - the resource does not exist.',
      },
    ],
    ...
    ml_mlops: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation:
          'MLOps enables reproducible ML pipelines with automated testing and deployment.',
      },
    ],
