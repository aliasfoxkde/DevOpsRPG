...
type CollectibleType = 'xp_boost' | 'gold_boost' | 'hint' | 'streak_shield' | 'mystery_box'
...
export const COLLECTIBLES_POOL: Collectible[] = [
  ...
  },
  {
    ...
    icon: '📖',
    rarity: 'epic',
    effect: { type: 'xp_multiplier', value: 5 },
    used: false,
  },
  ...
  },
  {
    ...
    icon: '🏦',
    rarity: 'epic',
    effect: { type: 'gold_multiplier', value: 5 },
    used: false,
  },
  ...
  // Streak shield
  {
    ...
    icon: '🛡️',
    rarity: 'rare',
    effect: { type: 'prevent_streak_loss', value: 1 },
    used: false,
  },
  ...
  // Mystery box
  {
    ...
    icon: '🎁',
    rarity: 'common',
    effect: { type: 'mystery_reward', value: 1 },
    used: false,
  },
  {
    id: 'mystery_rare',
    ...
    icon: '🎁',
    rarity: 'rare',
    effect: { type: 'mystery_reward', value: 2 },
    used: false,
  },
  {
    id: 'mystery_epic',
    ...
    icon: '✨',
    rarity: 'epic',
    effect: { type: 'mystery_reward', value: 3 },
    used: false,
  },
]
...
export const DAILY_REWARDS: DailyReward[] = [
  ...
  {
    day: 3,
    reward: { type: 'collectible', collectibleId: 'xp_small' },
    icon: '📜',
    claimed: false,
  },
  ...
  {
    day: 7,
    reward: { type: 'collectible', collectibleId: 'xp_medium' },
    icon: '📚',
    claimed: false,
  },
]
...
export function getRandomCollectible(rarity?: Collectible['rarity']): Collectible {
  const pool = rarity ? COLLECTIBLES_POOL.filter((c) => c.rarity === rarity) : COLLECTIBLES_POOL
...
export function openMysteryBox(box: Collectible): {
  ...
  const rewardMin = xpReward.min
  const rewardMax = xpReward.max
