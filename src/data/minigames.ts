...
export const mathChallenges: MathChallenge[] = [
  ...
  {
    id: 'bits_2',
    question: 'How many bytes in a kilobyte (KB)?',
    answer: 1024,
    hint: '2^10 bytes',
  },
  ...
  {
    id: 'cpu_cores',
    question: '2^6 CPU address lines = how many addresses?',
    answer: 64,
    hint: '2^6 = 64',
  },
  {
    id: 'hex_ff',
    question: 'What is 255 in binary (count the 1s)?',
    answer: 8,
    hint: '11111111 has 8 ones',
  },
  {
    id: 'subnet',
    question: 'What is 2^16 - 2 for subnet hosts?',
    answer: 65534,
    hint: '65536 - 2',
  },
  ...
  {
    id: 'container_1',
    question: 'A pod has 3 containers. Each needs 512MB. Total in MB?',
    answer: 1536,
    hint: '3 × 512',
  },
  {
    id: 'replicas_1',
    question: 'Scale from 2 to 5 replicas. Added how many?',
    answer: 3,
    hint: '5 - 2',
  },
  {
    id: 'build_time',
    question: 'Build takes 90 seconds. How many builds per hour max?',
    answer: 40,
    hint: '3600 / 90',
  },
]
...
function getCommandsByCategory(category: Command['category']): Command[] {
