# DevOpsQuest: The Eternal Pipeline

## A Compelling RPG Experience for Learning DevOps

---

## The Story: "The Great Outage"

### The Beginning

Ten years ago, the world relied on **The Eternal CI/CD** — an ancient automated system that silently deployed code to servers across the globe. It was the backbone of modern civilization: hospitals, banks, transportation, communication — all ran on its flawless deployments.

Then came **The Great Outage**.

A single malformed configuration file in the AWS region corrupted the deployment pipeline. Within hours, cascading failures spread across every cloud provider. Hospitals went dark. Air traffic halted. Financial markets froze. The world learned, in the most brutal way possible, why DevOps matters.

### The Aftermath

The guild of DevOps Engineers — the **Pipeline Paladins** — mobilized to restore order. It took three years to rebuild what had taken decades to create. But the corruption wasn't fully purged. It lurks in shadow systems, waiting.

### Your Call to Adventure

You are **The Newcomer** — chosen by the Guild to become a DevOps Master. The Elders have sensed it: **The Corruption stirs again**. In the shadows, automated systems are failing in ways that shouldn't be possible.

Your mission: **Master the Eternal Pipeline** — every technology, every practice, every tool — before The Corruption rises again. Only a true DevOps Master can face what lurks at the end.

---

## The World of DevOpsQuest
...
**Technologies:** CI/CD, Prometheus, Security
**Quests:** 12 topics
...
**Skill:** "Auto-Scale" — XP bar fills 10% faster
...
**Skill:** "Batch Execute" — Complete 2 quests per day streak bonus
...
**Skill:** "Query Insight" — Hints shown after wrong answer
...
**Skill:** "Wisdom of the Guild" — Unlocks all realm paths
...
- Incorrect Git branch in CI/CD config

**Rewards:** Bonus XP, unlocks "Debugging" skill
...
## The Final Boss: The Eternal CI/CD

Upon completing all five realms, you face **The Ultimate Quest**:

### The Corruption Returns

Derek reveals that The Great Outage's source — a corrupted CI/CD pipeline — still exists, hidden in the depths of the Citadel. It has been waiting, gathering strength. And now, only YOU can face it.

### The Final Battle

The final boss is not a single quest, but a **series of challenges** combining all your skills:

1. **Build Phase** — Create a complete web application (HTML + CSS + JS)
2. **Containerize Phase** — Package it in Docker with proper networking
3. **Orchestrate Phase** — Deploy to Kubernetes with scaling rules
4. **Monitor Phase** — Set up Prometheus metrics and alerts
5. **Secure Phase** — Implement security scanning and secrets management
6. **Deploy Phase** — Trigger the CI/CD pipeline and watch it deploy

Each phase has a time limit and scoring. Pass all phases to become a **DevOps Master**.
...
- You unlock "Endless Mode" — practice challenges infinitely
...
- **Headings:** "Cinzel" — Fantasy RPG serif feel
- **Body:** System UI — Clean readability
- **Code/Stats:** "Fira Code" — Monospace for commands
...
- Current title
- Streak counter (with fire animation if > 3)
- Gold counter
- Settings gear
...
- Achievements (button to open modal)

### Animations

1. **Quest Complete:** "+XP" floats up, golden burst, victory fanfare
2. **Level Up:** Screen flash, title announcement, new skill unlock
3. **Realm Unlock:** Path illuminates, dramatic reveal
4. **Streak Fire:** Animated flame when streak > 3
5. **Boss Approach:** Screen darkens, music builds
6. **Victory:** Confetti, stats summary, loot drops
...
- [x] Victory modal with rewards
- [x] XP bar HUD
- [x] Quest journal (QuestJournalPage)
- [x] Battle screen (BattleArenaPage)
...
- `/character` — Character Sheet (Stats/Equipment/Achievements)
- `/skills` — Skill Tree Modal
